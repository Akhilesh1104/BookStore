      ...
      <div className="fixed top-0 left-0 right-0 z-50">
        <div className="navbar bg-base-200 dark:bg-slate-900 dark:text-white">
          <div className="navbar-start">
            ...
            <a
              href="/"
              className="text-2xl md:text-3xl cursor-pointer font-bold mx-4 transform transition-transform duration-300 hover:scale-105"
            >
              BookStore
            </a>
          </div>
          <div className="navbar-end space-x-3">
            ...
            {authUser ? (
              ...
              <div className="">
                <button
                  className="btn btn-secondary md:mx-6"
                  onClick={() =>
